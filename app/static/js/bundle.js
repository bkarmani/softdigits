...
$("body").append(getFullscreenBg()), $.fn.initMM = function () {
    ...
    function (t) {
        ...
        function successForm(obj) {
            ...
            objMessage.addClass("tt-active"), setTimeout((function () {
                        ...
                        $("#success").fadeIn(), formjsFormMakeAppointment.each((function () {
                            ...
                            function successModal() {
                                if ($("body").hasClass("modal-open")) {
                                    ...
                                    objModal.find(".tt-modal-message").addClass("tt-active"), setTimeout((function () {
                                        objModal.find(".close").trigger("click"), objModal.find(".tt-modal-message").removeClass("tt-active")
                                    }), 1600)
                                }
                            }()
                    },
        ...
        var methods = {
            init: function (options) {
                return this.each((function () {
                    ...
                    objOpen.find(".tt-item__content").slideToggle(100), objItemTitle.on("click", (function () {
                        $(this).parent().hasClass("tt-item__open") || $(this).parent().siblings().removeClass("tt-item__open").find(".tt-item__content").slideUp(200), $(this).next().slideToggle(200).parent().toggleClass("tt-item__open")
                    }))
                }))
            }
        };
    ...
    function ($) {
        if (!$("#tt-header .js-dropdown-cart").length) return !1;
    ...
    }(jQuery), jQuery("#tt-pageContent [data-slick]").slick({
        lazyLoad: "progressive",
        dots: !0,
        arrows: !1,
        infinite: !0,
    ...
    function ($) {
        if (!$("#tt-pageContent .tt-slideinfo").length) return !1;
        $("#tt-pageContent .tt-slideinfo").on("mouseenter", (function () {
            ...
            var obj = $(this);
            return $(this).closest(".tt-slideinfo").hasClass("open-info") ? function closeLayout(obj) {
                obj.html("+"), obj.closest(".tt-slideinfo").removeClass("open-info")
            }(obj) : function openLayout(obj) {
                obj.html("-"), obj.closest(".tt-slideinfo").siblings().removeClass("open-info").find(".tt-item__btn  > *").html("+"), obj.closest(".tt-slideinfo").addClass("open-info")
            }(obj), !1
        }));
    ...
    }(jQuery), jQuery("#tt-pageContent .js-wrapper-gallery").magnificPopup({
        delegate: ".tt-gallery",
        type: "image",
        gallery: {
            enabled: !0
    ...
    function ($) {
        function calcHeight() {
            if ((window.innerWidth || $(window).width()) <= 786) return $("#tt-pageContent .layout01").each((function () {
...
if (mapElement) {
    function init() {
        ...
        new google.maps.Marker({
            ...
            map: map,
            icon: "../static/images/beachflag.png",
            title: "Snazzy!"
        })
    }
